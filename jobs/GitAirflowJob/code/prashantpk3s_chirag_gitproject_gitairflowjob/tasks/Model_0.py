from prashantpk3s_chirag_gitproject_gitairflowjob.utils import *
...
def Model_0():
    ...
    return PythonOperator(
        ...
        op_kwargs = {
          ...
          "threads": "",
          "exclude": "",
          "run_props": " --profile GitProjectFabric",
          "envs": {"DBT_DATABRICKS_INVOCATION_ENV" : "prophecy", "DBT_PROFILES_DIR" : "GitProject"}
        },
    )
